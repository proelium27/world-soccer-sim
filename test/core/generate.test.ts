...
describe("generateWorld", () => {
  ...
  it("produces 852 teams across 48 competitions, each its own size", () => {
    expect(world.teams).toHaveLength(852);
  ...
  it("has 21300 players (852 teams x 25)", () => {
    expect(world.players).toHaveLength(21300);
  });
