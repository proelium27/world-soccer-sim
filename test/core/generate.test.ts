...
describe("generateWorld", () => {
  ...
  it("produces 872 teams across 48 competitions, each its own size", () => {
    expect(world.teams).toHaveLength(872);
  ...
  it("has 21800 players (872 teams x 25)", () => {
    expect(world.players).toHaveLength(21800);
  });
