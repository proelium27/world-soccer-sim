...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "What you'll notice: nothing above about 80 sits in free agency any more, but there are usually ten to thirty players in the 70s, which is real squad depth for most clubs and a genuine signing for a small one. If you want someone who'd walk into a good top-division eleven, that's what loans and the transfer market are for now.",
