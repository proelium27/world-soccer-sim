...
const entry: ChangelogEntry = {
  ...
  items: [
    ...
    "I've given every position its own formula. They all start from the Player of the Season score: match rating, goals, assists and overall quality. Attacking midfielders, wingers and strikers are judged on that alone, so a forward who wins Player of the Season is always the best at his position in his league.",
