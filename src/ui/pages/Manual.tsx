      ...
      <div style={{ maxWidth: "56rem" }}>
        ...
        <Section id="godmode" title="God Mode">
          ...
          <ul>
            ...
            <li><strong>Rewrite the award formulas.</strong> The God Mode page has an Awards tab listing every weight the end-of-season awards are built from: what a goal or an assist is worth at each position, how much a player's match rating and overall count, the tackles and interceptions each position gets credit for in the Team of the Season, a keeper's save percentage, the appearances needed to qualify (19 out of the box), and everything the Ballon d&apos;Or and the other world awards add for league strength, trophies, cup runs and international football. Each box shows the shipped number beside it. Save and your formula is used the next time awards are handed out. Seasons already played keep their winners, and a reset puts the shipped formulas back. Worth knowing: a Team of the Season place is part of what makes a big club refuse to sell a star, so changing that formula also changes who&apos;s on the market. Like a ratings lock, it stays in force if you switch God Mode off, and the Awards page says so.</li>
