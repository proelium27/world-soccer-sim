...
const DEFAULT_DESCRIPTION =
  "Free browser soccer manager game. Take over a club, sign players, work the transfer market, run a youth academy and chase the title across 48 leagues and 884 clubs.";
