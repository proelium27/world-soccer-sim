...
import { saveLeague, loadLeague, elideWrittenEvents } from "../../db/leagueDb.js";
...
export function LeagueProvider({ children }: { children: ReactNode }) {
  ...
  const commitLeague = useCallback((given: LeagueStore | null, knownCrests?: ReadonlyMap<number, string>) => {
    ...
    // a timeline that is only in memory (see elideWrittenEvents).
    const l = given && elideWrittenEvents(given);
    leagueRef.current = l;
